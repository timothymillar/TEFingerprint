...
class TestTEFingerprint:
    ...
    @pytest.mark.parametrize('query,answer',
                             [(['tefingerprint', DATA_PATH + '/testA-2017-06-08.bam',  DATA_PATH + 'testB-2017-06-08.bam', '-f', 'Gypsy', 'PIF', '-e', '30000', '-m', '5', '-b', '10000', '-n', '0', '--no-max-count-proportion', '--gff', '-'],
                              ...
                              ('chr1\tTEFingerprint\t.\t2452\t24217\t.\t+\t.\tcategory=Gypsy;median=2973;sample_0_name=testA-2017-06-08.bam;sample_0_count=18;sample_1_name=testB-2017-06-08.bam;sample_1_count=20;max_count_proportion=0.5263157894736842;color=#C6DBEF;ID=Gypsy_chr1_+_24217;pair=Gypsy_chr1_-_3217\n'
                               ...
                               'chr1\tTEFingerprint\t.\t24787\t24919\t.\t-\t.\tcategory=Gypsy;median=24872;sample_0_name=testA-2017-06-08.bam;sample_0_count=12;sample_1_name=testB-2017-06-08.bam;sample_1_count=10;max_count_proportion=0.5454545454545454;color=#C6DBEF;ID=Gypsy_chr1_-_24787;pair=.\n')
                               ),
