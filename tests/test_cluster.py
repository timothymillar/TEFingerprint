...
class TestHUDC:
    ...
    def test_point_eps(self):
        ...
        npt.assert_array_equal(HUDC._core_distance(input_array, 10), point_eps)
    ...
    def test_point_eps_hidden_peak(self):
        ...
        npt.assert_array_equal(HUDC._core_distance(input_array, 3), point_eps)
    ...
    def test_eps_splits(self):
        ...
        npt.assert_array_equal(HUDC._epsilon_min_before_split(input_array, 10), split_eps)
    ...
    def test_eps_splits_hidden_peak(self):
        ...
        npt.assert_array_equal(HUDC._epsilon_min_before_split(input_array, 3), split_eps)
